  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-op_fps" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
	  ...
	  <div class="panel-body">
	 	 <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-op_fps" class="form-horizontal">
	 	 	<div class="form-group required">
	            <label class="col-sm-2 control-label" for="input-account"><?php echo $entry_account; ?></label>
	            <div class="col-sm-10">
	              <input type="text" name="op_fps_account" value="<?php echo $op_fps_account; ?>" placeholder="<?php echo $entry_account; ?>" id="input-account" class="form-control" />
	        ...
	        <div class="form-group required">
	            ...
	            <div class="col-sm-10">
	              <input type="text" name="op_fps_terminal" value="<?php echo $op_fps_terminal; ?>" placeholder="<?php echo $entry_terminal; ?>" id="input-terminal" class="form-control" />
	        ...
	        <div class="form-group required">
	            ...
	            <div class="col-sm-10">
	              <input type="text" name="op_fps_securecode" value="<?php echo $op_fps_securecode; ?>" placeholder="<?php echo $entry_securecode; ?>" id="input-securecode" class="form-control" />
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_transaction" id="input-transaction" class="form-control">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_pay_mode" id="input-pay-mode" class="form-control">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_default_order_status_id" id="input-default-order-status" class="form-control">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_success_order_status_id" id="input-success-order-status" class="form-control">
	                <?php foreach ($order_statuses as $order_status) { ?>
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_failed_order_status_id" id="input-failed-order-status" class="form-control">
	                <?php foreach ($order_statuses as $order_status) { ?>
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_pending_order_status_id" id="input-pending-order-status" class="form-control">
	                <?php foreach ($order_statuses as $order_status) { ?>
			...
			<div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_geo_zone_id" id="input-geo-zone" class="form-control">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <select name="op_fps_status" id="input-status" class="form-control">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-10">
	              <input type="text" name="op_fps_sort_order" value="<?php echo $op_fps_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
	            </div>
	        </div>
			...
			<div class="form-group">
			 ...
			 <div class="col-sm-10">
				<select name="op_fps_location" id="input-location" class="form-control">
				   <?php if ($op_fps_location) { ?>
			...
			<div class="form-group ">
			 ...
			 <div class="col-sm-10">
				<input type="text" name="op_fps_locations" value="<?php echo $op_fps_locations; ?>" placeholder="<?php echo $entry_locations; ?>" id="input-terminal" class="form-control" />
			 </div>
			</div>
			<div class="form-group">
			 <label class="col-sm-2 control-label" for="input-entity"><?php echo $entry_entity; ?></label>
			 <div class="col-sm-10">
				<select name="op_fps_entity" id="input-location" class="form-control">
				   <?php if ($op_fps_entity) { ?>
			...
			<div class="form-group ">
			 ...
			 <div class="col-sm-10">
				<input type="text" name="op_fps_entitys" value="<?php echo $op_fps_entitys; ?>" placeholder="<?php echo $entry_entitys; ?>" id="input-terminal" class="form-control" />
			 </div>
			</div>
